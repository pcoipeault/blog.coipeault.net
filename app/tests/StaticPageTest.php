...
class StaticPageTest extends WebTestCase {
    ...
    public function testMenu() {
        ...
        $this->assertEquals('http://cmf.symfony.com', $crawler->selectLink('Website')->attr('href'),
                'Page does not contain an a tag pointing to: cmf.symfony.com');
        ...
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
        $this->assertEquals('http://cmf.symfony.com', $crawler->selectLink('Webseite')->attr('href'),
                'Page does not contain an a tag pointing to: cmf.symfony.com');
    }
